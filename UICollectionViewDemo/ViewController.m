...
- (void)viewDidLoad
{
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, width,150)
                  ...
                  cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        return nil;
    }    NSString *imageName = [NSString stringWithFormat:@"%ld.JPG",indexPath.row];
